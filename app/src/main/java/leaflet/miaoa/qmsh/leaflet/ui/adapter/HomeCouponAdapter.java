 ...
 */
public class HomeCouponAdapter extends RecyclerView.Adapter<HomeCouponAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public HomeCouponAdapter(Context mContext, List<ListActivityBean.Product> productList) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        viewHolder.tv_introduce.setText(productList.get(position).getcIntro());
        viewHolder.tv_cNowPrice.setText(productList.get(position).getcNowPrice());
        viewHolder.tv_cFormerPrice.setText("起"+productList.get(position).getcFormerPrice());
